...
// TODO
const a = students.filter(s=>s.score>=80).map(student => student.name);
console.log("80 or more:", a);
...
// TODO
const copy=students.slice().sort((a,b)=>b.score-a.score);
copy.forEach((s,i)=>console.log(`${i + 1}. ${s.name} (${s.dept}) ${s.score}`));